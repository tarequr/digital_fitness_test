...
<div class="container">
  <div class="row mt-3">
    ...
    <div class="col-sm-6">
      <a href="{{ route('user.profile.view') }}" class="btn btn-primary float-right btn-sm"><i class="fa fa-user"></i> Your Profile</a>
    </div>
  </div>
	        ...
	        <div class="row">
	          <div class="col-lg-12">
	            <div class="p-5">
	              ...
	              <form class="user" method="POST" action="{{ route('user.profile.update') }}" enctype="multipart/form-data">
	                 @csrf
